...
{
    public class CustomWebApplicationFactoryImage<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureServices(services =>
            {
                ...
                {
                    options.UseInMemoryDatabase("InMemoryDbForTestingImage");
                });
